                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <h3 class="text-orange">Novo Cliente</h3>
                            </ul>
                            ...
                            <ul class="navbar-nav my-2 my-lg-0">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" title="Novo Cliente"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div>
                                                <select name="genre"
                                                    ...
                                                    <option
                                                        value="male" {{ (old('genre')  == 'male') ? 'selected' : '' }}>
                                                        Masculino
                                                    </option>
                                                    <option
                                                        value="female" {{ (old('genre')  == 'female') ? 'selected' : '' }}>
                                                        Feminino
                                                    </option>
                                                    <option
                                                        value="other" {{ (old('genre')  == 'other') ? 'selected' : '' }}>
                                                        Outros
                                                    </option>
                                                </select>
                                            </div>
